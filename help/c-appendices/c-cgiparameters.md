...
uuid: be245eea-187a-454a-9147-7a0b57428422
index: y
internal: n
snippet: y
---
...
<table id="table_802D1D13EA6F4DAAA45291B5DA90D2AC"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col03"> <p> </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_context_​field= field </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col03"> <p> </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_date_​range= number </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> </p> </td> 
   <td colname="col03"> <p>sp_date_​range_# </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_date_​range_#= number </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>sp_dedupe_​field </p> </td> 
   <td colname="col03"> <p> </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_dedupe_​field= fieldname </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col03"> <p> </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_end_day= number,​sp_end_month= number,​ sp_end_year= number </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>sp_not_​found_page </p> </td> 
   <td colname="col03"> <p> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col03"> <p> </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_pt= exact/​equivalent/compatible </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> <span class="codeph"> sp_pt_#= exact/​equivalent/compatible </span> </p> </td> 
...
&lt;input&nbsp;type="text"&nbsp;name="sp_q_year_1"&nbsp;size="4"&nbsp;value="2000"&gt;&nbsp;Year&nbsp; 
  ...
  <tr> 
   ...
   <td colname="col03"> <p>sp_q_​location_# </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_q_location=​ latitude/longitude OR areacode OR zipcode </span> </p> <p> <span class="codeph"> sp_q_location_#=​ latitude/longitude OR areacode OR zipcode </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>sp_q_max_​relevant_distance </p> </td> 
   <td colname="col03"> <p>sp_q_max _relevant _distance _# </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_q_max_relevant_​distance= value </span> </p> <p> <span class="codeph"> sp_q_max_relevant_​distance_#= value </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col03"> <p>sp_q_min_​day_#, sp_q_min_​month_#, sp_q_min_​year_# </p> <p> sp_q_max_​day_#, sp_q_max_​month_#, sp_q_max_​year_# </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_q_min_day=​ integer value </span> </p> <p> <span class="codeph"> sp_q_min_month=​ integer value </span> </p> <p> <span class="codeph"> sp_q_min_year=​ integer value </span> </p> <p> <span class="codeph"> sp_q_max_day=​ integer value </span> </p> <p> <span class="codeph"> sp_q_max_month=​ integer value </span> </p> <p> <span class="codeph"> sp_q_max_year=​ integer value </span> </p> <p> <span class="codeph"> sp_q_min_day_#=​ integer value </span> </p> <p> <span class="codeph"> sp_q_min_month_#=​ integer value </span> </p> <p> <span class="codeph"> sp_q_min_year_#=​ integer value </span> </p> <p> <span class="codeph"> sp_q_max_day_#=​ integer value </span> </p> <p> <span class="codeph"> sp_q_max_month_#=​ integer value </span> </p> <p> <span class="codeph"> sp_q_max_year_#=​ integer value </span> </p> </td> 
...
&lt;input&nbsp;type="hidden"&nbsp;name="sp_q_required_1"&nbsp;value="-1"&gt; 
  ...
  <tr> 
   ...
   <td colname="col03"> <p> </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_redirect_​if_one_result= 0 or 1 </span> </p> </td> 
...
Search&nbsp;for:&nbsp;&lt;input&nbsp;type="text"&nbsp;name="sp_q"&nbsp;value="Music&nbsp;Search"&gt; 
  ...
  <tr> 
   ...
   <td colname="col03"> <p> </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> sp_w= sound-​alike-enable </span> </p> <p> <span class="codeph"> sp_w_control=​ sound-alike-control </span> </p> </td> 
