...
uuid: b0dafcaf-9620-46c9-a75e-3cf4de272de8
index: y
internal: n
snippet: y
---
...
1. On the [!UICONTROL Standard Form Source] page, select and copy the HTML search form code that appears in the text field. 
...
1. On the [!UICONTROL Staged Templates] page, in the table, click the name of template with the targeted destination frame. 
