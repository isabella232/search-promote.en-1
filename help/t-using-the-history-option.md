...
uuid: 290db514-4491-4aaf-9144-fd0ce2ff9bd3
index: y
internal: n
snippet: y
---
...
You can also use [!UICONTROL History] to revert to a previously applied change that was made to the feature. The entry with a **bold** version value represents the current version and is always at the top of the list.
