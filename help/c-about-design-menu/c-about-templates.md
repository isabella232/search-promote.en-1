...
uuid: 636964d6-c3f5-404e-966b-e1f5bb360337
index: y
internal: n
snippet: y
---
...
You can use **[!UICONTROL Add Template]** to add presentation templates (.tmpl) or transport templates (.tpl) to the [!UICONTROL Templates] page.
...
1. On the [!UICONTROL Templates] page, click **[!UICONTROL Add New Template]**.
1. In the [!UICONTROL Add Template] dialog box, set the options that you want.
...
1. (Optional) On the [!UICONTROL Templates] page, do one of the following:
...
1. On the product menu, click **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. On the [!UICONTROL Templates] page, in the drop-down list next to a template name that you want to copy, click **[!UICONTROL Copy]**.
1. In the [!UICONTROL Copy Template] dialog box, set one or more of the options that you want.
...
You can use [!UICONTROL Rename Template] to change the name of an existing presentation template (.tmpl) or a transport template (.tpl).
...
1. On the product menu, click **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. On the [!UICONTROL Templates] page, in the drop-down list next to a template name that you want to rename, click **[!UICONTROL Rename]**.
1. In the [!UICONTROL Rename Template] dialog box, set one or more of the options that you want.
...
1. On the product menu, click **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. On the [!UICONTROL Templates] page, in the drop-down list next to a template name that you want to delete, click **[!UICONTROL Delete]**.
1. In the [!UICONTROL Delete Template] dialog box, click **[!UICONTROL Delete.]**
1. (Optional) Do one of the following:
...
1. On the product menu, click **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. On the [!UICONTROL Templates] page, in the drop-down list next to a presentation template name, click **[!UICONTROL Preview minimized]**.

   Use the **[!UICONTROL Type]** column in the Templates table to sort the templates by Presentation and Transport. 1. (Optional) On the [!UICONTROL Preview Minimized Template] page, check **[!UICONTROL Wrap lines]** to read the tags within the defined window.
...
1. On the product menu, click **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. On the [!UICONTROL Templates] page, under the [!UICONTROL Minimize] column, check the box for one or more presentation template files that you want to push as minimize on your website.

   Use the **[!UICONTROL Type]** column in the [!UICONTROL Templates] table to sort the templates by Presentation and Transport. 1. (Optional) Do one of the following:
...
1. On the product menu, click **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. On the [!UICONTROL Templates] page, under the [!UICONTROL Default] column, click the radio button to the corresponding presentation template file that you want to serve as the default.
...
You can use [!UICONTROL Preview] to review the XML of a transport template that you have added.
...
1. On the product menu, click **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. On the [!UICONTROL Templates] page, in the drop-down list next to a transport template name, click **[!UICONTROL Preview]**.

   Use the **[!UICONTROL Type]** column in the [!UICONTROL Templates] table to sort the templates by Presentation and Transport. 1. Close the viewing window and return to [!DNL site search/merchandising].
1. (Optional) Do one of the following:
