...
uuid: 32166903-fc44-4a60-9450-165be0784983
index: y
internal: n
snippet: y
---
...
You can add a data view to the [!UICONTROL Data Views] page to display the values of each meta field with a search query.
...
1. On the [!UICONTROL Data Views] page, click **[!UICONTROL Add New Data View]**.
1. In the [!UICONTROL Add New Data View] dialog box, in the [!UICONTROL Title] field, enter the name of the data view you want to create.
1. Click **[!UICONTROL Add]**.

## Editing a data view {#task_258A367896C24DD498C755925EA8F516}

When you add a data view to the [!UICONTROL Data Views] page, you use Edit to change the data view's name and description or to move, reveal, or hide the display of each meta field.
...
1. On the product menu, click **[!UICONTROL Reports]** > **[!UICONTROL Data Views]**.
1. On the [!UICONTROL Data Views] page, in the [!UICONTROL Actions] column of the table, click **[!UICONTROL Edit]** in the row with the data view that you want to change.
1. On the [!UICONTROL Data Views Editor] page, set the options you want.
...
You can copy an existing data view on the [!UICONTROL Data Views] page to use as the basis for creating a new data view.
...
1. On the product menu, click **[!UICONTROL Reports]** > **[!UICONTROL Data Views]**.
1. On the [!UICONTROL Data Views] page, in the [!UICONTROL Actions] column of the table, click **[!UICONTROL Copy]** in the row with the data view that you want to copy.
1. On the [!UICONTROL Copy Data View] page, in the [!UICONTROL New Title] text field, enter the new name that you want to assign the data view.
...
You can delete a data view on the [!UICONTROL Data Views] page that you no longer need or use.
...
1. On the product menu, click **[!UICONTROL Reports]** > **[!UICONTROL Data Views]**.
1. On the [!UICONTROL Data Views] page, in the [!UICONTROL Actions] column of the table, click **[!UICONTROL Delete]** in the row with the data view that you want to remove.
1. On the [!UICONTROL Delete Data View] page, click **Delete**.
1. (Optional) Do any of the following:
...
You can use [!UICONTROL View] on the [!UICONTROL Data Views] page to display a selected data view.
...
* On the [!UICONTROL Data Views] page, in the [!UICONTROL Title] column of the table, click the name of a data view that you want to open. 

* On the [!UICONTROL Data Views] page, in the [!UICONTROL Actions] column of the table, click **[!UICONTROL View]** in the row with the data view that you want to open.
