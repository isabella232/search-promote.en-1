...
uuid: 4224c788-d845-4a16-959e-4aa836ef055d
index: y
internal: n
snippet: y
---
...
* To filter alerts by date, in the [!UICONTROL Start Date] text field, the [!UICONTROL End Date] text field, or both, enter a date in MM/DD/YYYY format. 

* In the [!UICONTROL Sent To] text field, the [!UICONTROL Subject] text field, or both, enter words or phrases to find alerts that match the text you entered. 
