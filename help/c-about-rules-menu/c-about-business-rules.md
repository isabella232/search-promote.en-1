...
uuid: c8dbef7c-4aed-4150-bded-43165e3098cb
index: y
internal: n
snippet: y
---
...
You can use [!UICONTROL Visual Rule Builder] or [!UICONTROL Advanced Rule Builder] to add business rules that tailor your customer's search experience.
...
1. Do one of the following:
    ...
    * On the product menu, click **[!UICONTROL Rules]** > **[!UICONTROL Business Rules]**. On the [!UICONTROL Business Rules] page, click **[!UICONTROL Add New Rule]**. 
...
1. (Optional) If you manage a large number of business rules, you can tag business rules with specific labels. In the **[!UICONTROL Tags]** field, enter one or more tag labels, Use a comma, Tab, or Enter as a delimiter.
   ...
   On the [!UICONTROL Business Rules] page, use the **[!UICONTROL Filter by tag]** feature to filter for rules that match a given label. 1. On the [!UICONTROL Business Rule Builder] page, set the triggers and actions that you want to use.
...
1. (Optional) In any Business Rule Builder panel ( [!UICONTROL Triggers], [!UICONTROL Actions], or [!UICONTROL Schedule]), do one of the following:
    ...
    * In the presentation template area of the Business Rule Builder page area, right-click a banner, and then click **[!UICONTROL Select different banner]**. On the **[!UICONTROL Pick Banner]** page, click **[!UICONTROL Pick this banner]** below the banner thumbnail to add it to your presentation template. Only banners that match the size and area of the original banner on the presentation template are available for you to pick.
      ...
      The add banner action is added to the [!UICONTROL Actions] panel. 
    
    * In the presentation template area of the [!UICONTROL Business Rule Builder] page, right-click on an Adobe Scene7 template banner whose parameters you want to change, and then click **[!UICONTROL Add banner commands]**. In the [!UICONTROL Change Parameters] dialog box, set the parameter options that you want.
      ...
      The parameter changes are added to the [!UICONTROL Actions] panel.
...
1. (Optional) On the [!UICONTROL Business Rules] page, do one of the following:
...
1. On the [!UICONTROL Business Rules] page, do one of the following:

    * Under the [!UICONTROL Name] column, click the name of a business rule that you want to change.
...
1. In the [!UICONTROL Name] text field, type the new name of the business rule.
   ...
   Do not click **[!UICONTROL Save Rule]** yet. 1. On the [!UICONTROL Business Rule Builder] page, set the triggers and actions that you want to use.
...
1. (Optional) In any **[!UICONTROL Business Rule Builder]** panel ( [!UICONTROL Triggers], [!UICONTROL Actions], or [!UICONTROL Schedule], do any of the following:

    * In the presentation template area of the [!UICONTROL Business Rule Builder] page, right-click a banner, and then click **[!UICONTROL Select different banner]**. On the [!UICONTROL Pick Banner page], click **[!UICONTROL Pick this banner]** below the banner thumbnail to add it to your presentation template. Only banners that match the size and area of the original banner on the presentation template are available for you to pick.
    ...
    * In the presentation template area of the [!UICONTROL Business Rule Builder] page, right-click on a banner that you want to delete from the page, and then click **[!UICONTROL Remove banner]**. The remove banner action is added to the [!UICONTROL Actions] panel.
...
1. Click **[!UICONTROL Save Rule]**.
   ...
   The [!UICONTROL Business Rule Builder] page closes, and you are returned to the **[!UICONTROL Business Rule]** page. Your rules appear in the table. Click the **[!UICONTROL Modified]** column header to sort the rules by edit date. 1. (Optional) Do one of the following:
...
1. On the [!UICONTROL Business Rules] page, using the status column header in the [!UICONTROL Status] column of the business rules table, sort the rules that have a status of **[!UICONTROL WIP]** or **[!UICONTROL suspended]**.
...
1. On the product menu, click **[!UICONTROL Rule]** > **[!UICONTROL Business Rules]**.
1. On the [!UICONTROL Business Rules] page, using the status in the Status column of the business rules table, in the far left column of the table, check the rules that have a status of **[!UICONTROL WIP]**, or **[!UICONTROL approved]**.
...
1. On the product menu, click **[!UICONTROL Rule]** > **[!UICONTROL Business Rules]**.
1. On the [!UICONTROL Business Rules] page, using the status in the Status column of the business rules table, in the far left column of the table, check the rules that have a status of **[!UICONTROL suspended]**.
...
Business rules run in the order that they were defined; the higher a rule's order number, the later it runs in the process, trumping earlier rules. You reorder rules by entering a new number in the Order column of the table on the [!UICONTROL Business Rules] page. You can also use drag-and-drop on rules to change their run order.

**To change the order that business rules run** 

1. On the product menu, click **[!UICONTROL Rule]** > **[!UICONTROL Business Rules]**.
1. On the [!UICONTROL Business Rules] page, in the table, do any one of the following:
