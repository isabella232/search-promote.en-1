...
uuid: 59aa66c1-5324-4b7e-b85a-5c7d6cc3f17b
index: y
internal: n
snippet: y
---
...
1. In the [!UICONTROL Direct Hits] field, enter the URL of your website, and one or more comma-delimited search terms.
...
1. On the product menu, click **[!UICONTROL Rules]** > **[!UICONTROL Direct Hits]**.
1. In the [!UICONTROL Test Direct Hits] field, enter a search term, and then click **[!UICONTROL Test]**.
1. (Optional) Do one of the following:
