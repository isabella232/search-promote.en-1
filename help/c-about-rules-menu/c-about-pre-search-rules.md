...
uuid: 6a0dbaed-23a9-47f8-be68-9acf856ecc46
index: y
internal: n
snippet: y
---
...
You can use [!UICONTROL Pre-Search Rules] to select which presentation template is used to display the search results based on the incoming query.

<!-- 

t_adding_a_new_pre-search_rule.xml
...
1. On the [!UICONTROL Pre-Search Rules] page, click **[!UICONTROL Add New Rule]**.
1. In the [!UICONTROL Name] field, type the name of the new query cleaning rule.
1. On the [!UICONTROL Add Pre-Search Rule] page, use the drop-down lists and text fields to build out your query.
...
You can edit existing pre-search rules that you have added to the [!UICONTROL Pre-Search Rules] page.

<!-- 

t_editing_a_pre-search_rule.xml
...
1. On the product menu, click **[!UICONTROL Rules]** > **[!UICONTROL Pre-Search Rules]**.
1. On the [!UICONTROL Pre-Search Rules] page, under the **[!UICONTROL Actions]** column of the table, click **[!UICONTROL Edit]** for the associated rule that you want to edit.
1. On the [!UICONTROL Edit Pre-Search Rule] page, use the drop-down lists and text fields to build out your query.
...
t_deleting_a_pre-search_rule.xml
...
1. On the product menu, click **[!UICONTROL Rules]** > **[!UICONTROL Pre-Search Rules]**.
1. On the [!UICONTROL Pre-Search Rules] page, under the **[!UICONTROL Actions]** column of the table, click **[!UICONTROL Delete]** for the associated rule that you want to delete.
...
t_changing_the_order_that_pre-search_rules_run.xml

 -->

Pre-search rules run in the order that they were defined. The higher a rule's order number, the later it runs in the process, trumping earlier rules. You reorder rules by entering a new number in the Order column of the table on the [!UICONTROL Pre-Search Rules] page. You can also use drag-and-drop on rules to change their run order.

**To change the order that pre-search rules run** 

1. On the product menu, click **[!UICONTROL Rules]** > **[!UICONTROL Pre-Search Rules]**.
1. On the [!UICONTROL Pre-Search Rules] page, do one of the following:
