...
1. On the [!UICONTROL URL Entrypoints] page, in the [!UICONTROL Entrypoints] field, enter one URL address per line.
...
You can use [!UICONTROL URL Masks] to define which parts of your website that you want or do not want crawled and indexed.
...
1. (Optional) On the [!UICONTROL URL Masks] page, in the **[!UICONTROL Test URL Masks]** field, enter a test URL mask from your website, and then click **[!UICONTROL Test]**.
1. In the [!UICONTROL URL Masks] field, type `include` (to add a website that you want crawled and indexed), or type `exclude` (to block a website from getting crawled and indexed), followed by the URL mask address.
...
1. (Optional) On the [!UICONTROL Date Masks] page, in the **[!UICONTROL Test Date]** field, enter a date formatted as YYYY-MM-DD (for example, `2011-07-25`); in the **[!UICONTROL Test URL]** field, enter a URL mask from your website, and then click **[!UICONTROL Test]**.
1. In the [!UICONTROL Date Masks] field, enter one date mask address per line.
1. Click **[!UICONTROL Save Changes]**.
1. (Optional) Do any of the following:
...
On the [!UICONTROL Passwords] page, you type each password on a single line. The password consists of a URL or realm, a user name, and a password, as in the following example:
...
1. On the [!UICONTROL Passwords] page, in the **[!UICONTROL Passwords]** field, enter a realm or URL, and its associated user name, and password, separated by a space.
...
You can use [!UICONTROL Content Types] to select which types of files that you want to crawl and index for this account.
...
If you select the option **[!UICONTROL Text in MP3 Music Files]** on the [!UICONTROL Content Types] page, an MP3 file is crawled and indexed in one of two ways. The first and most common way is from an anchor href tag in an HTML file as in the following:
...
If your website contains many large MP3 files, you may exceed the indexing byte limit for your account. If this happens, you can deselect **[!UICONTROL Text in MP3 Music Files]** on the [!UICONTROL Content Types] page to prevent the indexing of all MP3 files on your website.
...
1. On the [!UICONTROL Content Types] page, check the file types that you want to crawl and index on your website.
1. Click **[!UICONTROL Save Changes]**.
1. (Optional) Do any of the following:
...
1. On the [!UICONTROL Parallel Indexing Connections] page, in the **[!UICONTROL Number of Connections]** field, enter the number of connections (1-10) that you want to add.
1. Click **[!UICONTROL Save Changes]**.
1. (Optional) Do any of the following:
...
You can use [!UICONTROL Form Submission] to help process forms that are recognized on your website for indexing purposes.
...
1. On the [!UICONTROL Form Submission] page, click **[!UICONTROL Add New Form]**.
1. On the [!UICONTROL Add Form Definition] page, set the [!UICONTROL Form Recognition] and [!UICONTROL Form Submission] options.
...
r_form_definition_options.xml
 ...
 -->
   ...
   The five options in the [!UICONTROL Form Recognition] section on the [!UICONTROL Form Definition] page are used to identify forms in your web pages that can be process.

   The three options in the [!UICONTROL Form Submission] section are used to specify the parameters and values that are submitted with a form to your web server.
...
Be aware that there is no [!UICONTROL History] feature on the [!UICONTROL Form Submission] page to revert any changes that you make to a form definition.
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Form Submission]**.
1. On the [!UICONTROL Form Submission] page, click **[!UICONTROL Edit]** to the right of a form definition that you want to update.
1. On the [!UICONTROL Edit Form Definition] page, set the [!UICONTROL Form Recognition] and [!UICONTROL Form Submission] options.
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Form Submission]**.
1. On the [!UICONTROL Form Submission] page, click **[!UICONTROL Delete]** to the right of a form definition that you want to remove.
...
1. On the [!UICONTROL Delete Form Definition] page, click **[!UICONTROL Delete]**.
1. (Optional) Do any of the following:
...
Use [!UICONTROL Index Connector] to define additional input sources for indexing XML pages or any kind of feed.
...
After you add an Index Connector definition to the [!UICONTROL Staged Index Connector Definitions] page, you can change any configuration setting, *except* for the Name or Type values.

The [!UICONTROL Index Connector] page shows you the following information:
...
Because the documents for XML crawls are already separated into individual files, steps 1 and 2 in the table above do not directly apply. If you specify a URL in the **[!UICONTROL Host Address]** and **[!UICONTROL File Path]** fields of the [!UICONTROL Index Connector Add] page, it is downloaded and processed as a normal HTML document. The expectation is that the download document contains a collection of `<a href="{url}"...` links, each of which points to an XML document that is processed. Such links are converted to the following form:
...
1. On the [!UICONTROL Stage Index Connector Definitions] page, click **[!UICONTROL Add New Index Connector]**.
1. On the [!UICONTROL Index Connector Add] page, set the connector options that you want. The options that are available depend on the **[!UICONTROL Type]** that you selected.
...
1. Click **[!UICONTROL Add]** to add the configuration to the [!UICONTROL Index Connector Definitions] page and to the [!UICONTROL Index Connector Configurations] drop-down list on the [!UICONTROL URL Entrypoints] page.

   See [About URL Entrypoints](../c-about-settings-menu/c-about-crawling-menu.md#concept_5D857E3B5C124E85BC0B5AE77A509573). 
1. On the [!UICONTROL Index Connector Definitions] page, click **[!UICONTROL rebuild your staged site index]**.
1. (Optional) On the [!UICONTROL Index Connector Definitions] page, do any of the following:
...
>[!NOTE]
>
>Not all options are available for you to change, such as the Index Connector Name or Type from the [!UICONTROL Type] drop-down list.

**To edit an Index Connector definition** 

1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Index Connector]**.
1. On the [!UICONTROL Index Connector] page, under the [!UICONTROL Actions] column heading, click **[!UICONTROL Edit]** for an Index Connector definition name whose settings you want to change.
1. On the [!UICONTROL Index Connector Edit] page, set the options you want.
...
1. Click **[!UICONTROL Save Changes]**.
1. (Optional) On the [!UICONTROL Index Connector Definitions] page, click **[!UICONTROL rebuild your staged site index]**.
1. (Optional) On the [!UICONTROL Index Connector Definitions] page, do any of the following:
...
After an Index Connector definition is added to the [!UICONTROL Index Connector Definitions] page, you cannot change its Type setting. Instead, you must delete the definition and then add a new one.

**To view the settings of an Index Connector definition ** 

1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Index Connector]**.
1. On the [!UICONTROL Index Connector] page, under the [!UICONTROL Actions] column heading, click **[!UICONTROL Edit]** for an Index Connector definition name whose settings you want to review or edit.
...
When copying an Index Connector definition, the copied definition is disabled by default. To enable or "turn on" the definition, you must edit it from the [!UICONTROL Index Connector Edit] page, and select **[!UICONTROL Enable]**.
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Index Connector]**.
1. On the [!UICONTROL Index Connector] page, under the [!UICONTROL Actions] column heading, click **[!UICONTROL Copy]** for an Index Connector definition name whose settings you want to duplicate.
1. On the [!UICONTROL Index Connector Copy] page, enter the new name of the definition.
...
After you rename the definition, check **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Entrypoints]**. You want to ensure that the new definition name is reflected in the drop-down list on the [!UICONTROL URL Entrypoints] page.
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Index Connector]**.
1. On the [!UICONTROL Index Connector] page, under the [!UICONTROL Actions] column heading, click **[!UICONTROL Rename]** for Index Connector definition name that you want to change.
1. On the [!UICONTROL Index Connector Rename] page, enter the new name of the definition in the [!UICONTROL Name] field.
...
1. Click **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL URL Entrypoints]**. If the previous Index Connector's name is present in the list, remove it, and add the newly renamed entry.
   ...
   See [Adding multiple URL entry points that you want indexed](../c-about-settings-menu/c-about-crawling-menu.md#task_2338A47387D74CFDAC4D4EF4A367ED45). 1. (Optional) On the [!UICONTROL Index Connector Definitions] page, do any of the following:
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Index Connector]**.
1. On the [!UICONTROL Index Connector Definitions] page, under the [!UICONTROL Actions] column heading, click **[!UICONTROL Delete]** for the Index Connector definition name you want to remove.
1. On the [!UICONTROL Index Connector Delete] page, click **[!UICONTROL Delete]**.
