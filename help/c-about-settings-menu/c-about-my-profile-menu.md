...
uuid: fe2d4e75-5f33-46c2-8886-e669df5ed708
index: y
internal: n
snippet: y
---
...
1. On the [!UICONTROL Personal Information] page, specify the fields that you want.

   Only the [!UICONTROL Email Address] field is required. 
...
1. On the [!UICONTROL My Preferences] page, set the fields that you want.
...
1. On the [!UICONTROL Change Password] page, in the [!UICONTROL Current Password] field, type the current login password that you use.
1. In the [!UICONTROL New Password] field and the [!UICONTROL New Password (again)] field, type the new login password that you want to use.
1. Click **Save Changes**.
...
1. On the [!UICONTROL Cancel Login] page, click **[!UICONTROL Cancel Login]**.
...
1. On the [!UICONTROL My Access Privileges] page, expand the tree views to review privileges or restricted access.
