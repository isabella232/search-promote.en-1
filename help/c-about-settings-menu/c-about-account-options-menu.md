...
1. On the [!DNL Adobe Analytics Redirector] page, set the options that you want.
    ...
    <tbody> 
      ...
      <li id="li_991BDCDDA41A445F85CEEAAE9A46A304"> In <span class="wintitle"> Config Section </span>, find line the looks like the following: <p> <code> s.trackingServer="yourcompany.122.2o7.net" </code> </p> <p>The tracking server name, in this case, is <span class="codeph"> "yourcompany.122.2o7.net" </span> </p> </li> 
      </ol> </p> </td> 
      </tr> 
      <tr> 
