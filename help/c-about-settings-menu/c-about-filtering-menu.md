...
You can use [!UICONTROL Filtering Script] to change the content of a Web document before it is indexed.
...
1. (Optional) On the [!UICONTROL Filtering Script] page, in the [!UICONTROL Test URL] field, enter the URL of a document on your website.
...
1. In the [!UICONTROL Filtering Script] field, paste your script.
...
1. (Optional) Rebuild your staged site index if you want to preview the results.
   ...
   See [Configuring an incremental index of a staged website](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0). 
1. (Optional) On the [!UICONTROL Filtering Script] page, do any of the following:
...
You can use [!UICONTROL Initialization Script] to change the content of a Web document before it is indexed.
...
1. (Optional) On the [!UICONTROL Initialization Script] page, in the [!UICONTROL Test URL] field, enter the URL of a document on your website.
...
1. In the [!UICONTROL Initialization Script] field, paste your script.
1. (Optional) Click **[!UICONTROL Check Syntax]** to perform a quick syntax check of your script by running the filtering, initialization, and termination scripts.
...
1. (Optional) Rebuild your staged site index if you want to preview the results.
   ...
   See [Configuring an incremental index of a staged website](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0). 
1. (Optional) On the [!UICONTROL Initialization Script] page, do any of the following:
...
You can use [!UICONTROL Termination Script] to change the content of a Web document before it is indexed.
...
1. (Optional) On the [!UICONTROL Termination Script] page, in the [!UICONTROL Test URL] field, enter the URL of a document on your website.
...
1. In the [!UICONTROL Termination Script] field, paste your script.
...
1. (Optional) Rebuild your staged site index if you want to preview the results.
   ...
   See [Configuring an incremental index of a staged website](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0). 
1. (Optional) On the [!UICONTROL Termination Script] page, do any of the following:
...
Scripted URL masks are considered in the order that you entered them in the [!UICONTROL URL Masks] field. When a document URL matches a mask, that document is included or excluded based on the type of mask. If a document's URL does not match any URL mask, the document is included only if its MIME type is "text/html". All other MIME types are excluded. 
...
1. (Optional) On the [!UICONTROL URL Masks] page, in the [!UICONTROL Test URL] field, enter a URL of a document on your website, and then click **[!UICONTROL Test]** to test the URL against the filtering scripts and masks.
...
1. In the [!UICONTROL URL Masks] field, enter one URL mask per line.
...
1. (Optional) Rebuild your staged site index if you want to preview the results.
   ...
   See [Configuring an incremental index of a staged website](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0). 
1. (Optional) On the [!UICONTROL URL Masks] page, do any of the following:
...
1. On the [!UICONTROL Content Types] page, check the content types that you want pass to the filter script.
1. Click **[!UICONTROL Save Changes]**.
1. (Optional) Rebuild your staged site index if you want to preview the results.

   See [Configuring an incremental index of a staged website](../c-about-index-menu/c-about-incremental-index.md#task_46A367B0786C4C90BFFA5D3F95FD86C0). 
1. (Optional) On the [!UICONTROL Content Types] page, do any of the following:
