...
uuid: dbc516f1-524d-405d-8219-6e0d7dd4c591
index: y
internal: n
snippet: y
---
...
* On the [!DNL Feeds] page, under the [!DNL Name] column of the table, click the drop-down list next to a feed name, and then click **[!UICONTROL Edit feed]**. 

* On the [!DNL Feeds] page, under the [!DNL Name] column, click the name of a feed that you want to change.
...
1. At the end of the wizard, in the [!DNL Verification] panel, click **[!UICONTROL Close]**.
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Searching]** > **[!UICONTROL Feeds]**.
1. In the [!DNL Feeds Menu] screen, under the [!DNL Actions] column, click **[!UICONTROL Delete]** for the feed name that you want to remove.
1. In the [!DNL Delete feed] dialog box, click **[!UICONTROL Yes]** to confirm the deletion.
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Searching]** > **[!UICONTROL Feeds]**.
1. On the [!DNL Feeds] page, under the [!DNL Name] column of the table, click the drop-down list next to a feed name, and then click **[!UICONTROL View Feed Files]**.
1. In the [!DNL Verification] panel of the feed's wizard, click **[!UICONTROL Show Data View]**.
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Searching]** > **[!UICONTROL Feeds]**.
1. On the [!DNL Feeds] page, under the [!DNL Name] column of the table, click the drop-down list next to a feed name, and then click **[!UICONTROL Test Feed (No file upload)]**.
1. On the [!DNL Feeds] page, the [!DNL Feed Status] column is updated during and following the test.

## Generating and uploading a feed {#task_C9A57827C7674035B62A22D310DDAA0C}

You can manually generate and submit feed files to the final destination, regardless of the schedule that you set in the [!DNL File Submission] panel of the Feed wizard.
...
1. On the product menu, click **[!UICONTROL Settings]** > **[!UICONTROL Searching]** > **[!UICONTROL Feeds]**.
1. On the [!DNL Feeds] page, under the [!DNL Name] column of the table, click the drop-down list next to a feed name, and then click **[!UICONTROL Generate and Upload Feed]**.
1. On the [!DNL Feeds] page, the [!DNL Feed Status] column is updated during and following the data feed generation and upload.
