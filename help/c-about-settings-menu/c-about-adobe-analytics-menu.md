...
If the table is empty, it means that you have not loaded any Adobe Analytics data yet. You can close the [!UICONTROL Adobe Analytics Data Preview] page, and then load Adobe Analytics data.
